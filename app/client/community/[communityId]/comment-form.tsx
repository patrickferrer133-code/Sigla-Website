...
export function CommentForm({ postId, communityId, crisisResources }: { postId: string; communityId: string; crisisResources: CrisisResource[] }) {
  ...
  return (
    <div className="mt-2">
      <form action={formAction} className="flex gap-2">
        ...
        <Button type="submit" size="sm" variant="ghost" disabled={isPending}>Reply</Button>
      </form>
