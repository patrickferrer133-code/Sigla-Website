    ...
    <form action={formAction} className="flex flex-col gap-4">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1">
          ...
          <select id="kind" name="kind" defaultValue="article" className="h-9 rounded-md border bg-background px-2 text-sm">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select id="visibility" name="visibility" defaultValue="public" className="h-9 rounded-md border bg-background px-2 text-sm">
